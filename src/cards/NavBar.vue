...
<template>
  <div 
    class="navbar fixed h-20 lg:h-14 xl:h-10 bottom-0 left-0 z-900 shadow-[0_2px_5px_rgba(0,0,0,0.1)] bg-[#0b1120] lg:bottom-auto lg:top-0 lg:shadow-[0_-3px_20px_rgba(156,156,156,0.5)]"
  >
    <div 
      class="flex flex-row w-full max-w-screen justify-around lg:justify-between items-center lg:px-4 xl:px-8 2xl:px-64"
    >
      ...
      <a v-for="(value, id) in props.sectionTitles" :key="id"
        ...
        class="flex flex-col lg:flex-row items-center min-w-1/6 lg:min-w-36 xl:min-w-0 no-underline rounded-lg font-medium lg:font-normal lg:uppercase transition-all duration-[250ms] hover:text-blue-400 lg:py-2 xl:py-4 lg:px-4 xl:px-4 lg:hover:bg-white/10"
