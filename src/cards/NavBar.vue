...
<template>
  ...
  >
    <div 
      class="flex flex-row w-full max-w-screen justify-around items-center  lg:justify-between lg:px-4 xl:px-8"
    >
      ...
      <a v-for="(value, id) in props.sectionTitles" :key="id"
        ...
        class="flex flex-col items-center min-w-1/6 no-underline rounded-lg font-medium transition-all duration-[250ms] hover:text-blue-400 lg:flex-row lg:min-w-36 xl:min-w-0 lg:py-2 xl:py-4 lg:px-4 xl:px-8 lg:hover:bg-white/10"
